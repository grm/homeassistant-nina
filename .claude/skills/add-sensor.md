...
1. Add a `SensorEntityDescription` to `SENSOR_DESCRIPTIONS` in `custom_components/nina_polaris/sensor.py`
2. Add the data extraction logic in the `_extract_value` method's mapping dict
3. Add the translation string in `custom_components/nina_polaris/strings.json` under `entity.sensor`
