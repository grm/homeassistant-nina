...
async def test_step_user_cannot_connect(config_flow):
    ...
    with patch.object(
        ...
        await config_flow.async_step_user(user_input={CONF_HOST: "badhost", CONF_PORT: DEFAULT_PORT})
...
async def test_step_user_timeout(config_flow):
    ...
    with patch.object(
        ...
        await config_flow.async_step_user(user_input={CONF_HOST: "slowhost", CONF_PORT: DEFAULT_PORT})
